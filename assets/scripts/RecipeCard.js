...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let wrapper_article = document.createElement('article');
		// A3. TODO - Create a style element - This will hold all of the styles for the Web Component
		let wrapper_style = document.createElement('style');
  ...
  time {
    ...
    font-size: 12px;
		...
		wrapper_style.textContent = card_style;
		// A5. TODO - Append the <style> and <article> elements to the Shadow DOM
		shadow.appendChild(wrapper_article);
		shadow.appendChild(wrapper_style);
	}
	...
	set data(data) {
		...
		let doc_article = this.shadowRoot.querySelector('article')
		...
		let ratingPic = "./assets/images/icons/"+ rating +"-star.svg";
		doc_article.innerHTML = `<img src="` + source + `"
    	alt="`+ img_alt + `">
  		<p class="title">
 		...
 		<div class="rating">
    		<span>`+  rating + `</span>
    		<img src="`+  ratingPic  +`" alt="` + rating + ` stars">
